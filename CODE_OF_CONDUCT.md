...
This is a security tool, and that creates one additional expectation. Do not use
this repository — issues, pull requests, or discussions — to publish
vulnerabilities in third parties' systems, to share scan results for domains you
do not own, or to coordinate scanning of targets without authorization. Reports
about a real, unremediated weakness in someone else's infrastructure belong with
that party, not here.

Vulnerabilities in `certnotify` itself go to <security@certnotify.com>. See
...
reported to the maintainers at <support@certnotify.com>. All complaints will be
